...
// form event handlers
    ...
    async function getCurrency(currency) {
      ...
      function printArrow(change) {
        if (change>0) return `<img class="arrow" src="arrow.png" style="transform: rotate(); width:20px; height: 20px;">`;
          else if (change<0) return `<img class="arrow" src="arrow.png" style="transform: rotate(90deg); width:20px; height: 20px;"`;
          else return ``;
      }
